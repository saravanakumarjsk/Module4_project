...
<script>
	...
	function redirectF() {
		...
		if (name == null || name == "") {
			document.getElementById("namechecker").innerHTML = "Please Enter Biller Name";
		...
		if (address == null || address == "") {
			document.getElementById("addresschecker").innerHTML = "Please Enter Address";
		...
		if (city == null || city == "") {
			document.getElementById("citychecker").innerHTML = "Please Enter City";
	...
	<form action="New_Biller">
		<table align="center">
			...
			<tr>
				...
				<td><p>&nbsp;</p></td>
				<td><input type="radio" id="Active" name="status" checked>Active
					<input type="radio" id="Inactive" name="status">Inactive</td>
			</tr>
			<tr>
